...
<div className='p-5 oswald-font m-5'>
  ...
  <div className="row">
    <div style={{borderRadius:"25px"}} className="col bg-ap zoom py-5 mx-3 text-light">
...
<div className="container pb-5">
  ...
  <div className="row ">
    <div style={{borderRadius:"25px"}} className="col pt-5 p-3 mx-3 bg-photo1 zoom">
    <p className='text-light text-start b-p'>Patient Care Customer Spotlight: Dr. Jessica</p>
    </div>
    <div style={{borderRadius:"25px"}} className="col pt-5 p-3 mx-3 bg-photo2 zoom">
  <p className='text-light text-start b-p'>Special visit premiums with insights into billing best practices and frequently occurring errors.</p>
    ...
    <div style={{borderRadius:"25px"}} className="col pt-5 p-3 mx-3 bg-photo3 zoom">
    ...
    <div style={{borderRadius:"25px"}} className="col pt-5 p-3 mx-3 bg-photo4 zoom">
